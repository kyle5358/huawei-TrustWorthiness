...
def train_model(datafile, modelfile, resultdir, npochos=100, batch_size=50, retrain=False):
    ...
    test3_dataset = TensorDataset(test_triple,test_transE, test_ComplEx, test_path,test_confidence)
...
def test_model(model, test1_loader,test2_loader,test3_loader, resultfile):
    ...
    with torch.no_grad():
        ...
        for batch1,batch2,batch3 in zip(test1_loader,test2_loader,test3_loader):
                test_triple,test_transE, test_ComplEx, test_path,test_confidence=batch3
...
if __name__ == "__main__":
    ...
    modelfile = "./model/model_test.h5"  # 装模型
    resultdir = "./result/"
