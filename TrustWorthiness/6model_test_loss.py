...
class MLP(nn.Module):
    ...
    def forward(self,batch1_edge_index,batch1_x,batch2_edge_index,batch2_x,transE_input,ComplEx_input,path_input,edit_input):
        ...
        BP_input = torch.cat((transE_input.unsqueeze(1),ComplEx_input.unsqueeze(1),path_input.unsqueeze(1),edit_input.unsqueeze(1),gcnh_out), dim=1)
...
if __name__ == "__main__":
    ...
    modelfile = "./model/model_loss.h5"  # 装模型
    resultdir = "../result/"
